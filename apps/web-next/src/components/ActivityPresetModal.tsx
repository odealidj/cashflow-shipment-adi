        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <div>
            <h2 className="text-base font-bold text-slate-900">
              {isEdit ? `Edit Master #${preset?.id}` : "Tambah Master Keterangan / Rute"}
            </h2>
            <p className="text-xs text-slate-500">
              {isEdit ? "Perbarui pilihan preset standar transaksi" : "Daftarkan pilihan standar agar penulisan transaksi selalu seragam"}
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                ...
                <span>Keterangan Aktivitas / Armada</span>
              </button>
              ...
              >
                ...
                <span>Rute & Catatan Delivery</span>
              </button>
            </div>
          </div>
          ...
          <div>
            <label className="block text-xs font-bold text-slate-700 mb-1">
              Nama Keterangan / Rute <span className="text-rose-500">*</span>
            </label>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <textarea
                rows={2}
                placeholder="Penjelasan kapasitas truk, syarat pengiriman, atau rute spesifik..."
