...
export function ShipmentModal({ isOpen, onClose, onSuccess }: ShipmentModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-fade-in overflow-y-auto">
      <div className="glass-panel w-full max-w-2xl rounded-3xl p-6 relative my-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1 ml-1">Vendor Name (Auto Register)</label>
              <input
                type="text"
                required
                ...
                className="w-full glass-input rounded-xl py-2.5 px-4 focus:ring-2 focus:ring-brand-500"
                placeholder="Vendor PT XYZ"
              />
            </div>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-300 mb-1 ml-1">Shipment Information / Route</label>
            <input
              type="text"
              required
              ...
              className="w-full glass-input rounded-xl py-2.5 px-4 focus:ring-2 focus:ring-brand-500"
              placeholder="Pengiriman JKT - SBY"
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 border-t border-white/10 pt-5 mt-2">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1 ml-1">Selling Price</label>
              <input
                type="number"
                min="0"
                required
          ...
          <div className="bg-red-500/5 p-4 rounded-xl border border-red-500/20">
            ...
            <p className="text-xs text-gray-400 mb-3 ml-1">Fill this if you are making an immediate payment. It will deduct the rolling saldo.</p>
